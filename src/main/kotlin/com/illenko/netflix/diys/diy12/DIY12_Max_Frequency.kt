package com.illenko.netflix.diys.diy12 // ktlint-disable filename
...
internal class FreqStack {
    ...
    private var frequency = mutableMapOf<Int, Int>()
    private var group = mutableMapOf<Int, Stack<Int>>()
    ...
    fun push(data: Int) {
        ...
        val f = frequency.getOrDefault(data, 0) + 1
        frequency[data] = f
        ...
        group.computeIfAbsent(f) { Stack() }.push(data)
    }
